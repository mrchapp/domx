...
RPC_OMX_ERRORTYPE RPC_ModDeInit(void)
{
    ...
    DOMX_DEBUG("Entered %s",__FUNCTION__);
...
RPC_OMX_ERRORTYPE RPC_ModInit(void)
{
    ...
    DOMX_DEBUG("Entered: RPC_ModInit()");
...
EXIT:
    DOMX_DEBUG(" Exitting %s",__FUNCTION__);
    return rpcError;
...
RPC_OMX_ERRORTYPE _RPC_ClientCreate(OMX_STRING cComponentName)
{
    ...
    */
    ...
    DOMX_DEBUG(" Heap ID configured : %d\n", rcmParams.heapId);
