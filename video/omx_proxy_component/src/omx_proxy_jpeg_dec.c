 ...
 ******************************************************************************
 ...
 componentinit() of the proxy is called  static OMX_ERRORTYPE PROXY_Wrapper_init
...
#define COMPONENT_NAME "OMX.TI.DUCATI1.IMAGE.JPEGD"
...
OMX_ERRORTYPE OMX_ComponentInit(OMX_HANDLETYPE hComponent)
{
	...
	DOMX_DEBUG("_____________________INSIDE JPEG DECODER PROXY "
	...
	pComponentPrivate->cCompName = (OMX_U8 *)
	...
	TIMM_OSAL_Memcpy(pComponentPrivate->cCompName,
			COMPONENT_NAME, strlen(COMPONENT_NAME) + 1);
