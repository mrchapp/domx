...
#define COMPONENT_NAME "OMX.TI.DUCATI1.IMAGE.JPEGD" // needs to be specific for every configuration wrapper

OMX_ERRORTYPE OMX_JPEGD_Proxy_ComponentInit (OMX_HANDLETYPE hComponent)
{
	...
	DOMX_DEBUG("\n_____________________INSIDE JPEG DECODER PROXY WRAPPER__________________________\n");
