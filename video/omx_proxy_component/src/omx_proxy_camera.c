...
#define COMPONENT_NAME "OMX.TI.DUCATI1.VIDEO.CAMERA" // needs to be specific for every configuration wrapper

OMX_ERRORTYPE OMX_Camera_Proxy_ComponentInit (OMX_HANDLETYPE hComponent)
{
	...
	DOMX_DEBUG("\n_____________________INSIDE CAMERA PROXY WRAPPER__________________________\n");
