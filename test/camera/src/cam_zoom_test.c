...
* ======================================================================= */
/**
* @file cam_zoom_test.c
*
* This File contains testcase for the Camera Zoom Feature.
*
*
...
#define FRAMES_TO_PREVIEW	600
#define CAM_ZOOM_IN_START_ON_FRAME  100 /* Count from 0 */
#define CAM_ZOOM_IN_FRAMES          7
#define CAM_ZOOM_IN_STEP            0x10000
int zoom_frame_count;
int zoom_level = 1;
int zoom_in = 1;
	...
	while (OMX_ErrorNone == err) {
		...
		while (numRemainingIn) {
			...
			if (pBuffHeader->nOutputPortIndex ==
				...
				dprintf(0, "Buffer supplied doesn't contain\
						proper port \n");
			}
				...
				OMX_IN OMX_BUFFERHEADERTYPE *pBuffHeader)
{
	...
	dprintf(3, " Before writing to the FBD pipe \n");
