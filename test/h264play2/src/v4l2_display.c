...
void *v4l2_display_buffer(void *pBuffer)
{
    ...
    else
    {
        ...
        v4l2_fps = (time1.tv_sec - time0.tv_sec) + 0.000001 * (time1.tv_usec - time0.tv_usec);
        v4l2_fps /= (v4l2_bufs_streamed - 10);
        if (v4l2_fps) v4l2_fps = 1 / v4l2_fps;
        P("Q[%d] fps = %4.2g T=%d ms", filledbuffer.index, v4l2_fps, ((time1.tv_sec&0xF)*1000+time1.tv_usec/1000));
    }
