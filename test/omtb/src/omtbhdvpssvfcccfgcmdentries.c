...
\******************************************************************************/
/** @file     omtbHDVPSSVfccCfgCmdEntries.c
 *
 *  @brief    This file contains command entries of VPSS VFCC configuration
 *            parameters.
 *
 * <B> History: </B>
 *
...
PRIVATE MX_DBG_CMD_ENTRY_T cmdEntryVPSSVfccCompName =
{
  ...
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,compName),
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,inputFile) -
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,compName),
  0,
  0,
...
PRIVATE MX_DBG_CMD_ENTRY_T cmdEntryVPSSVfccOutFile =
{
  ...
  MX_DBG_CMD_OPT_INST_CUR     |
  MX_DBG_CMD_OPT_VALID_PTR,
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,outputFile),
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,inputFile) -
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,outputFile),
  0,
  0,
...
PRIVATE MX_DBG_CMD_ENTRY_T cmdEntryVPSSVfccWidth =
{
  ...
  MX_DBG_CMD_OPT_DEC      |
  MX_DBG_CMD_OPT_VALID_PTR,
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,frameWidth),
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,inputFile) -
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,frameWidth),
  0,
  0,
...
PRIVATE MX_DBG_CMD_ENTRY_T cmdEntryVPSSVfccHeight =
{
  ...
  MX_DBG_CMD_OPT_DEC          |
  MX_DBG_CMD_OPT_VALID_PTR,
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,frameHeight),
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,inputFile) -
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,frameHeight),
  0,
  0,
...
PRIVATE MX_DBG_CMD_ENTRY_T cmdEntryVPSSVfccOutputChromaFormat =
{
  ...
  MX_DBG_CMD_OPT_ENUM          |
  MX_DBG_CMD_OPT_VALID_PTR,
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,colorFormat),
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,inputFile) -
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,colorFormat),
  0,
...
PRIVATE MX_DBG_CMD_ENTRY_T cmdEntryVPSSVfccOutputMode =
{
  ...
  MX_DBG_CMD_OPT_ENUM          |
  MX_DBG_CMD_OPT_VALID_PTR,
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,dataOutPutMode),
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,inputFile) -
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,dataOutPutMode),
  0,
  OMTB_FILE,
...
PRIVATE MX_DBG_CMD_ENTRY_T cmdEntryVPSSVfccFlagUseAllocInBuffer =
{
  "inbuf",
  MX_DBG_CMD_TYPE_VAR_UINT32,
  MX_DBG_CMD_OPT_INST_CUR     |
  MX_DBG_CMD_OPT_ENUM          |
  MX_DBG_CMD_OPT_VALID_PTR,
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,flagUseInBuffer),
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,inputFile) -
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,flagUseInBuffer),
  0,
  OMX_FALSE,
...
PRIVATE MX_DBG_CMD_ENTRY_T cmdEntryVPSSVfccFlagUseAllocOutBuffer =
{
  ...
  MX_DBG_CMD_OPT_ENUM          |
  MX_DBG_CMD_OPT_VALID_PTR,
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,flagUseOutBuffer),
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,inputFile) -
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,flagUseOutBuffer),
  0,
  OMX_FALSE,
...
PRIVATE MX_DBG_CMD_ENTRY_T cmdEntryVPSSVfccNumInBuf =
{
  "numinbuf",
  MX_DBG_CMD_TYPE_VAR_UINT32,
  MX_DBG_CMD_OPT_INST_CUR     |
  MX_DBG_CMD_OPT_DEC      |
  MX_DBG_CMD_OPT_VALID_PTR,
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,numInBuf),
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,inputFile) -
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,numInBuf),
  0,
  0,
  OMTB_VPSS_VFCC_MAX_NUM_IN_BUFS,
  0,
  NULL,
  XdbgCmdVarFunc,
...
PRIVATE MX_DBG_CMD_ENTRY_T cmdEntryVPSSVfccNumOutBuf =
{
  ...
  MX_DBG_CMD_OPT_DEC      |
  MX_DBG_CMD_OPT_VALID_PTR,
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,numOutBuf),
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,inputFile) -
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,numOutBuf),
  0,
  0,
...
/* Entry for Set Capture Channel Name */

PRIVATE MX_DBG_CMD_ENTRY_T cmdEntryVPSSVfccChannelName =
{
  "chan_name",
  MX_DBG_CMD_TYPE_VAR_STR_BUF,
  MX_DBG_CMD_OPT_INST_CUR     |
  MX_DBG_CMD_OPT_VALID_PTR,
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,sChannelName.cChannelName),
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,inputFile) -
  FIELDOFFSET(OMTB_VPSS_VFCC_CONFIG_PARAMS,sChannelName.cChannelName),
  0,
  0,
...
MX_DBG_CMD_ENTRY_T* cmdListVPSSVfccConfig[] =
{
  ...
  &cmdEntryVPSSVfccFlagUseAllocInBuffer,
  &cmdEntryVPSSVfccFlagUseAllocOutBuffer,
  &cmdEntryVPSSVfccNumInBuf,
  &cmdEntryVPSSVfccNumOutBuf,
  &cmdEntryVPSSVfccChannelName,
  NULL
};
